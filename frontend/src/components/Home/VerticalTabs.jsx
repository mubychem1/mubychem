...
<div className="flex flex-col lg:flex-row items-center max-w-7xl w-full">
     ...
     <div className="w-full lg:w-1/2 px-6">
       ...
       <p className="text-[#6a7391] mt-3">
         Quality has always been our point of focus and it is of utmost importance to us.
       </p>
      ...
      <div className="w-1/4 ">
        <ul className="space-y-2">
          {tabs.map((tab, index) => (
            <li
              key={index}
              className={`flex justify-between items-center w-5/5 p-3 rounded-full transition-all duration-300 ${
                activeTab === index ? 'bg-white text-gray-900' : 'border border-gray-300 text-gray-900 bg-transparent'
              }`}
