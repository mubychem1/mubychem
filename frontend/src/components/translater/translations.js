const translations = {
  en: {
    ...
    SPECIALTY_CHEMICALS: "We specialize in producing high-quality specialty chemicals and excipients.",
    PHARMACEUTICAL_INDUSTRY: "Our products are known for their purity and effectiveness, supporting various industries worldwide.",
    ...
    mubyChemDescription2: "We work with industries around the world, supporting the development of exceptional products that enhance health, wellness, and industrial performance. Whether you need customized chemical solutions, nutraceutical ingredients, or specialty chemical formulations, Muby Chem is your trusted partner.",

    apis: "APIs",
    apisDescription: "Health research, sometimes referred to as medical research.",
    mineralActives: "Mineral Actives",
    mineralActivesDescription: "Accurate Analysis is an absolute testing laboratory.",
    knowMore: "Know More",
  ...
  hi: {
    ...
    CONTENT: "हम विशेष गुणवत्ता वाले विशेष रसायनों और सहायक पदार्थों के उत्पादन में विशेषज्ञ हैं। हमारे उत्पाद उनकी शुद्धता और प्रभावशीलता के लिए जाने जाते हैं, जो दुनियाभर के विभिन्न उद्योगों का समर्थन करते हैं।",
    ...
    mubyChemDescription2: "हम दुनिया भर के उद्योगों के साथ काम करते हैं, असाधारण उत्पादों के विकास का समर्थन करते हैं जो स्वास्थ्य, कल्याण और औद्योगिक प्रदर्शन को बढ़ाते हैं। चाहे आपको अनुकूलित रासायनिक समाधान, न्यूट्रास्यूटिकल सामग्री या विशेषता रासायनिक फॉर्मूलेशन की आवश्यकता हो, मुबी केम आपका विश्वसनीय भागीदार है।",
    apis: "एपीआई",
    apisDescription: "स्वास्थ्य अनुसंधान, जिसे कभी-कभी चिकित्सा अनुसंधान के रूप में जाना जाता है।",
  ...
  fr: {
    ...
    //---------- Home Section ---------
    qualityChemicals: "Produits chimiques de qualité dans le monde entier - Depuis 1976",
    ...
    pharmaceuticalsDescription: "Nous fabriquons des ingrédients pharmaceutiques actifs (APIs) et des excipients de haute qualité qui servent de base aux formulations pharmaceutiques. Nos produits sont soigneusement fabriqués dans des conditions contrôlées pour garantir leur puissance, leur pureté et leur efficacité.",
    specialitychemicalsTitle: "Produits chimiques spécialisés",
    specialitychemicalsDescription: "Des solutions chimiques sur mesure conçues spécialement pour vos besoins, garantissant des résultats optimaux et une intégration transparente dans vos processus de production.",
    nutraceuticalsTitle: "Nutraceutiques",
    nutraceuticalsDescription: "Nous sommes spécialisés dans le développement et la fabrication. Nos nutraceutiques combinent le meilleur de la nature et de la science pour offrir des solutions avancées et efficaces pour divers besoins en matière de santé et d'alimentation. Notre engagement envers la qualité garantit que chaque produit que nous créons répond aux normes les plus élevées en matière de sécurité, d'efficacité et de conformité réglementaire.",
    ...
    apis: "APIs",
    apisDescription: "La recherche en santé, parfois appelée recherche médicale.",
    mineralActives: "Actifs minéraux",
    mineralActivesDescription: "L'analyse précise est un laboratoire de test absolu.",
