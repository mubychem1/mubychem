...
const Simple = () => {
  ...
  return (
    <>
          ...
          <table className='w-full text-gray-300'>
            <tbody>
              ...
              <tr className="border-b border-gray-300">
                <td className="py-2">
                  <span className="font-bold text-[#773135]">CAS No:</span>
                  <span className="pl-58 text-black">{product.casNo}</span>
                </td>
              </tr>
              <tr className="border-b border-gray-300">
                <td className="py-2">
                  <span className="font-bold text-[#773135]">Dosage Form:</span>
                  <span className="pl-48 text-black">{product.dosageForm}</span>
                </td>
              </tr>
              <tr className="border-b border-gray-300">
                <td className="py-2">
                  <span className="font-bold text-[#773135]">Therapeutic Category:</span>
                  <span className="pl-32 text-black">{product.therapeuticCategory}</span>
                </td>
              </tr>
              <tr className="border-b border-gray-300">
                <td className="py-2">
                  <span className="font-bold text-[#773135]">Regulatory Filing:</span>
                  <span className="pl-40 text-black">{product.regulatoryFiling}</span>
                </td>
              </tr>
              <tr>
                <td className="py-2">
                  <span className="font-bold text-[#773135]">Muby Product Status:</span>
                  <span className="pl-33 text-black">{product.productStatus}</span>
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div className="bg-white p-8 rounded-lg w-full mx-auto font-sans">
          <h2 className="text-2xl font-bold mb-4 text-[#773135]">Application of {product.name}</h2>
          ...
          <div className="mb-4">
            ...
            <p className="text-sm">
             {product.pharmaceuticalApplications
}
            </p>
          </div>
