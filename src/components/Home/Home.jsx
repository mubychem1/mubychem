            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundImage: `url(${service.bgImage})` }} // Dynamic Background
                ></div>
...
// {/* <div className="relative w-full bg-[#011938] text-white p-10 flex items-center justify-between">
//         {/* Left Section */}
//         <div className="text-left mb-6">
//           <button className="bg-[#011938] text-white border border-white px-4 py-2 rounded-full text-sm">OUR SERVICE</button>
//           <h2 className="text-4xl font-semibold mt-4">Reliable & High Quality Service</h2>
//         </div>
...
{/* <div key={index} className="w-[300px] bg-[#011938] p-6 rounded-2xl flex-shrink-0 border border-gray-500 h-[400px]">
<div className="text-4xl">{service.icon}</div>
<h3 className="mt-4 text-xl font-semibold">{service.title}</h3>
<p className="mt-2 text-sm opacity-75">{service.description}</p>
<div className="mt-4">
